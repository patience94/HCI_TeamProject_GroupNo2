...
(function (root, factory) {
    ...
    adsk.fusion.BoundaryFillFeatureInput.prototype.cancel = function () {
        var result = this._execute('cancel');
        return result ? result.value : undefined;
    };
    ...
    adsk.fusion.CopyPasteBodies = function CopyPasteBodies(handle) {
        if (!(this instanceof adsk.fusion.CopyPasteBodies)) {
            return adsk.fusion.CopyPasteBodies.cast(handle);
        }
        adsk.core.Base.call(this, handle);
    };
    adsk.fusion.CopyPasteBodies.prototype = Object.create(adsk.core.Base.prototype);
    adsk.fusion.CopyPasteBodies.prototype.constructor = adsk.fusion.CopyPasteBodies;
    adsk.fusion.CopyPasteBodies.classType = function classType () {
        return 'adsk::fusion::CopyPasteBodies';
    };
    adsk.fusion.CopyPasteBodies.interfaceId = 'adsk.fusion.CopyPasteBodies';
    adsk.objectTypes['adsk.fusion.CopyPasteBodies'] = adsk.fusion.CopyPasteBodies;
    adsk.fusion.CopyPasteBodies.cast = function (object) {
        return object instanceof adsk.fusion.CopyPasteBodies ? object : null;
    };

    // The number of Copy/Paste Body features in the collection.
    Object.defineProperty(adsk.fusion.CopyPasteBodies.prototype, 'count', {
        get : function () {
            var result = this._execute('count');
            return result ? result.value : undefined;
        }
    ...
    // index : The index of the item within the collection to return. The first item in the collection has an index of 0.
    // Returns the specified item or null if an invalid index was specified.
    adsk.fusion.CopyPasteBodies.prototype.item = function (index) {
        if (!isFinite(index)) { throw new TypeError('index must be a number'); }
        var args = {
            index : Number(index)
        };
        var result = this._execute('item', args);
        return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.CopyPasteBody) : null;
    };

    // Function that returns the specified Copy/Paste Body feature using the name of the feature.
    // name : The name of the feature within the collection to return. This is the name seen in the timeline.
    // Returns the specified item or null if the specified name was not found.
    adsk.fusion.CopyPasteBodies.prototype.itemByName = function (name) {
        if (name === undefined || name === null || name.constructor !== String) { throw new TypeError('name must be a string'); }
        var args = {
            name : name
        };
    ...
    adsk.fusion.CopyPasteBodies.prototype.add = function (sourceBody) {
        if (sourceBody !== null && !(sourceBody instanceof adsk.core.Base)) { throw new TypeError('sourceBody must be a adsk.core.Base'); }
        var args = {
            sourceBody : (sourceBody === null ? sourceBody : sourceBody.handle)
        };
        var result = this._execute('add', args);
        return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.CopyPasteBody) : null;
    };
    ...
    adsk.fusion.CutPasteBodies = function CutPasteBodies(handle) {
        if (!(this instanceof adsk.fusion.CutPasteBodies)) {
            return adsk.fusion.CutPasteBodies.cast(handle);
        }
        adsk.core.Base.call(this, handle);
    };
    adsk.fusion.CutPasteBodies.prototype = Object.create(adsk.core.Base.prototype);
    adsk.fusion.CutPasteBodies.prototype.constructor = adsk.fusion.CutPasteBodies;
    adsk.fusion.CutPasteBodies.classType = function classType () {
        return 'adsk::fusion::CutPasteBodies';
    };
    adsk.fusion.CutPasteBodies.interfaceId = 'adsk.fusion.CutPasteBodies';
    adsk.objectTypes['adsk.fusion.CutPasteBodies'] = adsk.fusion.CutPasteBodies;
    adsk.fusion.CutPasteBodies.cast = function (object) {
        return object instanceof adsk.fusion.CutPasteBodies ? object : null;
    };

    // The number of Cut/Paste Body features in the collection.
    Object.defineProperty(adsk.fusion.CutPasteBodies.prototype, 'count', {
        get : function () {
            var result = this._execute('count');
            return result ? result.value : undefined;
        }
    ...
    // index : The index of the item within the collection to return. The first item in the collection has an index of 0.
    // Returns the specified item or null if an invalid index was specified.
    adsk.fusion.CutPasteBodies.prototype.item = function (index) {
        if (!isFinite(index)) { throw new TypeError('index must be a number'); }
        var args = {
            index : Number(index)
        };
        var result = this._execute('item', args);
        return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.CutPasteBody) : null;
    };

    // Function that returns the specified Cut/Paste Body feature using the name of the feature.
    // name : The name of the feature within the collection to return. This is the name seen in the timeline.
    // Returns the specified item or null if the specified name was not found.
    adsk.fusion.CutPasteBodies.prototype.itemByName = function (name) {
        if (name === undefined || name === null || name.constructor !== String) { throw new TypeError('name must be a string'); }
        var args = {
            name : name
        };
    ...
    // Returns the newly created BRepBody object or null in the case of failure.
    adsk.fusion.CutPasteBodies.prototype.add = function (sourceBody) {
        if (sourceBody !== null && !(sourceBody instanceof adsk.core.Base)) { throw new TypeError('sourceBody must be a adsk.core.Base'); }
        var args = {
            sourceBody : (sourceBody === null ? sourceBody : sourceBody.handle)
        };
    ...
    Object.defineProperty(adsk.fusion.Features.prototype, 'offsetFacesFeatures', {
        get : function () {
            var result = this._execute('offsetFacesFeatures');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.OffsetFacesFeatures) : null;
        }
    });
    ...
    Object.defineProperty(adsk.fusion.Features.prototype, 'copyPasteBodies', {
        get : function () {
            var result = this._execute('copyPasteBodies');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.CopyPasteBodies) : null;
        }
    });
    ...
    Object.defineProperty(adsk.fusion.Features.prototype, 'cutPasteBodies', {
        get : function () {
            var result = this._execute('cutPasteBodies');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.CutPasteBodies) : null;
        }
    });
    ...
    adsk.fusion.FormFeatures.prototype.add = function () {
        var result = this._execute('add');
        return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.FormFeature) : null;
    };
    ...
    adsk.fusion.OffsetFacesFeatures = function OffsetFacesFeatures(handle) {
        if (!(this instanceof adsk.fusion.OffsetFacesFeatures)) {
            return adsk.fusion.OffsetFacesFeatures.cast(handle);
        }
        adsk.core.Base.call(this, handle);
    };
    adsk.fusion.OffsetFacesFeatures.prototype = Object.create(adsk.core.Base.prototype);
    adsk.fusion.OffsetFacesFeatures.prototype.constructor = adsk.fusion.OffsetFacesFeatures;
    adsk.fusion.OffsetFacesFeatures.classType = function classType () {
        return 'adsk::fusion::OffsetFacesFeatures';
    };
    adsk.fusion.OffsetFacesFeatures.interfaceId = 'adsk.fusion.OffsetFacesFeatures';
    adsk.objectTypes['adsk.fusion.OffsetFacesFeatures'] = adsk.fusion.OffsetFacesFeatures;
    adsk.fusion.OffsetFacesFeatures.cast = function (object) {
        return object instanceof adsk.fusion.OffsetFacesFeatures ? object : null;
    };

    // The number of Offset Face features in the collection.
    // Offset Face features are created in the UI using the "Press Pull" command.
    Object.defineProperty(adsk.fusion.OffsetFacesFeatures.prototype, 'count', {
        get : function () {
            var result = this._execute('count');
            return result ? result.value : undefined;
        }
    ...
    // index : The index of the item within the collection to return. The first item in the collection has an index of 0.
    // Returns the specified item or null if an invalid index was specified.
    adsk.fusion.OffsetFacesFeatures.prototype.item = function (index) {
        if (!isFinite(index)) { throw new TypeError('index must be a number'); }
        var args = {
            index : Number(index)
        };
        var result = this._execute('item', args);
        return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.OffsetFacesFeature) : null;
    };
    ...
    // name : The name of the feature within the collection to return. This is the name seen in the timeline.
    // Returns the specified item or null if the specified name was not found.
    adsk.fusion.OffsetFacesFeatures.prototype.itemByName = function (name) {
        if (name === undefined || name === null || name.constructor !== String) { throw new TypeError('name must be a string'); }
        var args = {
            name : name
        };
    ...
    Object.defineProperty(adsk.fusion.SweepFeatureInput.prototype, 'taperAngle', {
        get : function () {
            var result = this._execute('taperAngle');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.ValueInput) : null;
        },
    ...
    // A negative angle will taper the sweep inward while a positive value will taper
    // the sweep outward. This property is valid for both parametric and non-parametric extrusions.
    Object.defineProperty(adsk.fusion.SweepFeatureInput.prototype, 'twistAngle', {
        get : function () {
            var result = this._execute('twistAngle');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.ValueInput) : null;
        },
        set : function (value) {
            if (value !== null && !(value instanceof adsk.core.ValueInput)) { throw new TypeError('value must be a adsk.core.ValueInput'); }
            ...
            var result = this._execute('twistAngle', args);
            return result ? result.value : undefined;
        }
    });
    ...
    adsk.fusion.TrimFeatureInput.prototype.cancel = function () {
        var result = this._execute('cancel');
        return result ? result.value : undefined;
    };
    ...
    adsk.fusion.CopyPasteBody = function CopyPasteBody(handle) {
        if (!(this instanceof adsk.fusion.CopyPasteBody)) {
            return adsk.fusion.CopyPasteBody.cast(handle);
        }
        adsk.fusion.Feature.call(this, handle);
    };
    adsk.fusion.CopyPasteBody.prototype = Object.create(adsk.fusion.Feature.prototype);
    adsk.fusion.CopyPasteBody.prototype.constructor = adsk.fusion.CopyPasteBody;
    adsk.fusion.CopyPasteBody.classType = function classType () {
        return 'adsk::fusion::CopyPasteBody';
    };
    adsk.fusion.CopyPasteBody.interfaceId = 'adsk.fusion.CopyPasteBody';
    adsk.objectTypes['adsk.fusion.CopyPasteBody'] = adsk.fusion.CopyPasteBody;
    adsk.fusion.CopyPasteBody.cast = function (object) {
        return object instanceof adsk.fusion.CopyPasteBody ? object : null;
    };
    ...
    Object.defineProperty(adsk.fusion.CopyPasteBody.prototype, 'sourceBody', {
        get : function () {
            var result = this._execute('sourceBody');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.ObjectCollection) : null;
        }
    });
    ...
    adsk.fusion.CutPasteBody = function CutPasteBody(handle) {
        if (!(this instanceof adsk.fusion.CutPasteBody)) {
            return adsk.fusion.CutPasteBody.cast(handle);
        }
        adsk.fusion.Feature.call(this, handle);
    };
    adsk.fusion.CutPasteBody.prototype = Object.create(adsk.fusion.Feature.prototype);
    adsk.fusion.CutPasteBody.prototype.constructor = adsk.fusion.CutPasteBody;
    adsk.fusion.CutPasteBody.classType = function classType () {
        return 'adsk::fusion::CutPasteBody';
    };
    adsk.fusion.CutPasteBody.interfaceId = 'adsk.fusion.CutPasteBody';
    adsk.objectTypes['adsk.fusion.CutPasteBody'] = adsk.fusion.CutPasteBody;
    adsk.fusion.CutPasteBody.cast = function (object) {
        return object instanceof adsk.fusion.CutPasteBody ? object : null;
    };
    ...
    Object.defineProperty(adsk.fusion.CutPasteBody.prototype, 'sourceBody', {
        get : function () {
            var result = this._execute('sourceBody');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.ObjectCollection) : null;
        }
    ...
    Object.defineProperty(adsk.fusion.FormFeature.prototype, 'tSplineBodies', {
        get : function () {
            var result = this._execute('tSplineBodies');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.TSplineBodies) : null;
        }
    });

    // Set the user-interface so that the form body is in edit mode.
    // Returns true if successful.
    adsk.fusion.FormFeature.prototype.startEdit = function () {
        var result = this._execute('startEdit');
        return result ? result.value : undefined;
    };
    ...
    // in edit mode, then nothing happens.
    // Returns true if successful.
    adsk.fusion.FormFeature.prototype.finishEdit = function () {
        var result = this._execute('finishEdit');
        return result ? result.value : undefined;
    };
    ...
    // Offset Face features are created in the UI using the "Press Pull" command.
    adsk.fusion.OffsetFacesFeature = function OffsetFacesFeature(handle) {
        if (!(this instanceof adsk.fusion.OffsetFacesFeature)) {
            return adsk.fusion.OffsetFacesFeature.cast(handle);
        }
        adsk.fusion.Feature.call(this, handle);
    };
    adsk.fusion.OffsetFacesFeature.prototype = Object.create(adsk.fusion.Feature.prototype);
    adsk.fusion.OffsetFacesFeature.prototype.constructor = adsk.fusion.OffsetFacesFeature;
    adsk.fusion.OffsetFacesFeature.classType = function classType () {
        return 'adsk::fusion::OffsetFacesFeature';
    };
    adsk.fusion.OffsetFacesFeature.interfaceId = 'adsk.fusion.OffsetFacesFeature';
    adsk.objectTypes['adsk.fusion.OffsetFacesFeature'] = adsk.fusion.OffsetFacesFeature;
    adsk.fusion.OffsetFacesFeature.cast = function (object) {
        return object instanceof adsk.fusion.OffsetFacesFeature ? object : null;
    };
    ...
    Object.defineProperty(adsk.fusion.SweepFeature.prototype, 'taperAngle', {
        get : function () {
            var result = this._execute('taperAngle');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.ModelParameter) : null;
        }
    ...
    // The value of the angle can be edited by using the properties on the ModelParameter object to edit the parameter.
    Object.defineProperty(adsk.fusion.SweepFeature.prototype, 'twistAngle', {
        get : function () {
            var result = this._execute('twistAngle');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.ModelParameter) : null;
        }
