...
(function (root, factory) {
    ...
    Object.defineProperty(adsk.fusion.Joint.prototype, 'isLocked', {
        get : function () {
            var result = this._execute('isLocked');
            return result ? result.value : undefined;
        },
        set : function (value) {
            if (typeof value !== 'boolean') { throw new TypeError('value must be a boolean'); }
            ...
            var result = this._execute('isLocked', args);
            return result ? result.value : undefined;
        }
    });
    ...
    adsk.fusion.Occurrence.prototype.breakLink = function () {
        var result = this._execute('breakLink');
        return result ? result.value : undefined;
    };
    ...
    Object.defineProperty(adsk.fusion.Component.prototype, 'jointOrigins', {
        get : function () {
            var result = this._execute('jointOrigins');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.JointOrigins) : null;
        }
    });

    // Returns the customGraphicsGroups object in this component.
    Object.defineProperty(adsk.fusion.Component.prototype, 'customGraphicsGroups', {
        get : function () {
    ...
    Object.defineProperty(adsk.fusion.Component.prototype, 'revisionId', {
        get : function () {
