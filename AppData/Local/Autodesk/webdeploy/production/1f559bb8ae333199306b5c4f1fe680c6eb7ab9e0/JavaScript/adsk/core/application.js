...
(function (root, factory) {
    ...
    Object.defineProperty(adsk.core.Application.prototype, 'measureManager', {
        get : function () {
            var result = this._execute('measureManager');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.MeasureManager) : null;
        }
    });
    ...
    adsk.core.Application.prototype.executeTextCommand = function (command) {
        if (command === undefined || command === null || command.constructor !== String) { throw new TypeError('command must be a string'); }
        var args = {
            command : command
        };
        var result = this._execute('executeTextCommand', args);
        return result ? result.value : undefined;
    };
    ...
    // by this document.
    Object.defineProperty(adsk.core.Document.prototype, 'documentReferences', {
        get : function () {
            var result = this._execute('documentReferences');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.DocumentReferences) : null;
        }
    });
    ...
    Object.defineProperty(adsk.core.Document.prototype, 'isUpToDate', {
        get : function () {
            var result = this._execute('isUpToDate');
            return result ? result.value : undefined;
        }
    });
    ...
    Object.defineProperty(adsk.core.Document.prototype, 'allDocumentReferences', {
        get : function () {
            var result = this._execute('allDocumentReferences');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.DocumentReferences) : null;
        }
    });
    ...
    adsk.core.DocumentReference = function DocumentReference(handle) {
        if (!(this instanceof adsk.core.DocumentReference)) {
            return adsk.core.DocumentReference.cast(handle);
        }
        adsk.core.Base.call(this, handle);
    };
    adsk.core.DocumentReference.prototype = Object.create(adsk.core.Base.prototype);
    adsk.core.DocumentReference.prototype.constructor = adsk.core.DocumentReference;
    adsk.core.DocumentReference.classType = function classType () {
        return 'adsk::core::DocumentReference';
    };
    adsk.core.DocumentReference.interfaceId = 'adsk.core.DocumentReference';
    adsk.objectTypes['adsk.core.DocumentReference'] = adsk.core.DocumentReference;
    adsk.core.DocumentReference.cast = function (object) {
        return object instanceof adsk.core.DocumentReference ? object : null;
    };

    // The dataFile on A360 that this object references.
    Object.defineProperty(adsk.core.DocumentReference.prototype, 'dataFile', {
        get : function () {
            var result = this._execute('dataFile');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.DataFile) : null;
        }
    ...
    Object.defineProperty(adsk.core.DocumentReference.prototype, 'referencedDocument', {
        get : function () {
            var result = this._execute('referencedDocument');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.Document) : null;
        }
    });
    ...
    // that version.
    Object.defineProperty(adsk.core.DocumentReference.prototype, 'version', {
        get : function () {
            var result = this._execute('version');
            return result ? result.value : undefined;
        },
        set : function (value) {
            ...
            var result = this._execute('version', args);
            return result ? result.value : undefined;
        }
    });

    // The document that is doing the referencing and owns this reference.
    Object.defineProperty(adsk.core.DocumentReference.prototype, 'parentDocument', {
        get : function () {
    ...
    Object.defineProperty(adsk.core.DocumentReference.prototype, 'isOutOfDate', {
        get : function () {
            var result = this._execute('isOutOfDate');
            return result ? result.value : undefined;
        }
    });
    ...
    adsk.core.DocumentReference.prototype.getLatestVersion = function () {
        var result = this._execute('getLatestVersion');
        return result ? result.value : undefined;
    };

    //=========== DocumentReferences ============
    // Provides access to the list of documents referenced from a document.
    adsk.core.DocumentReferences = function DocumentReferences(handle) {
        if (!(this instanceof adsk.core.DocumentReferences)) {
            return adsk.core.DocumentReferences.cast(handle);
        }
        adsk.core.Base.call(this, handle);
    };
    adsk.core.DocumentReferences.prototype = Object.create(adsk.core.Base.prototype);
    adsk.core.DocumentReferences.prototype.constructor = adsk.core.DocumentReferences;
    adsk.core.DocumentReferences.classType = function classType () {
        return 'adsk::core::DocumentReferences';
    };
    adsk.core.DocumentReferences.interfaceId = 'adsk.core.DocumentReferences';
    adsk.objectTypes['adsk.core.DocumentReferences'] = adsk.core.DocumentReferences;
    adsk.core.DocumentReferences.cast = function (object) {
        return object instanceof adsk.core.DocumentReferences ? object : null;
    };

    // The number of DocumentReference objects in this collection.
    Object.defineProperty(adsk.core.DocumentReferences.prototype, 'count', {
        get : function () {
            var result = this._execute('count');
            return result ? result.value : undefined;
        }
    ...
    adsk.core.DocumentReferences.prototype.item = function (index) {
        if (!isFinite(index)) { throw new TypeError('index must be a number'); }
        var args = {
            index : Number(index)
        };
        var result = this._execute('item', args);
        return (result && result.value) ? adsk.createObject(result.value, adsk.core.DocumentReference) : null;
    };
    ...
    adsk.core.ImportManager.prototype.importToTarget2 = function (importOptions, target) {
        if (importOptions !== null && !(importOptions instanceof adsk.core.ImportOptions)) { throw new TypeError('importOptions must be a adsk.core.ImportOptions'); }
        if (target !== null && !(target instanceof adsk.core.Base)) { throw new TypeError('target must be a adsk.core.Base'); }
        var args = {
            importOptions : (importOptions === null ? importOptions : importOptions.handle),
        ...
        var result = this._execute('importToTarget2', args);
        return (result && result.value) ? adsk.createObject(result.value, adsk.core.ObjectCollection) : null;
    };
    ...
    adsk.core.MeasureManager = function MeasureManager(handle) {
        if (!(this instanceof adsk.core.MeasureManager)) {
            return adsk.core.MeasureManager.cast(handle);
        }
        adsk.core.Base.call(this, handle);
    };
    adsk.core.MeasureManager.prototype = Object.create(adsk.core.Base.prototype);
    adsk.core.MeasureManager.prototype.constructor = adsk.core.MeasureManager;
    adsk.core.MeasureManager.classType = function classType () {
        return 'adsk::core::MeasureManager';
    };
    adsk.core.MeasureManager.interfaceId = 'adsk.core.MeasureManager';
    adsk.objectTypes['adsk.core.MeasureManager'] = adsk.core.MeasureManager;
    adsk.core.MeasureManager.cast = function (object) {
        return object instanceof adsk.core.MeasureManager ? object : null;
    };
    ...
    adsk.core.MeasureManager.prototype.getOrientedBoundingBox = function (geometry, lengthVector, widthVector) {
        if (geometry !== null && !(geometry instanceof adsk.core.Base)) { throw new TypeError('geometry must be a adsk.core.Base'); }
        if (lengthVector !== null && !(lengthVector instanceof adsk.core.Vector3D)) { throw new TypeError('lengthVector must be a adsk.core.Vector3D'); }
        if (widthVector !== null && !(widthVector instanceof adsk.core.Vector3D)) { throw new TypeError('widthVector must be a adsk.core.Vector3D'); }
        var args = {
            geometry : (geometry === null ? geometry : geometry.handle),
            lengthVector : (lengthVector === null ? lengthVector : lengthVector.handle),
            widthVector : (widthVector === null ? widthVector : widthVector.handle)
        };
        var result = this._execute('getOrientedBoundingBox', args);
        return (result && result.value) ? adsk.createObject(result.value, adsk.core.OrientedBoundingBox3D) : null;
    };
    ...
    adsk.core.MeasureManager.prototype.measureMinimumDistance = function (geometryOne, geometryTwo) {
        if (geometryOne !== null && !(geometryOne instanceof adsk.core.Base)) { throw new TypeError('geometryOne must be a adsk.core.Base'); }
        if (geometryTwo !== null && !(geometryTwo instanceof adsk.core.Base)) { throw new TypeError('geometryTwo must be a adsk.core.Base'); }
        var args = {
            geometryOne : (geometryOne === null ? geometryOne : geometryOne.handle),
            geometryTwo : (geometryTwo === null ? geometryTwo : geometryTwo.handle)
        };
        var result = this._execute('measureMinimumDistance', args);
        return (result && result.value) ? adsk.createObject(result.value, adsk.core.MeasureResults) : null;
    };
    ...
    adsk.core.MeasureManager.prototype.measureAngle = function (geometryOne, geometryTwo, geometryThree) {
        if (geometryOne !== null && !(geometryOne instanceof adsk.core.Base)) { throw new TypeError('geometryOne must be a adsk.core.Base'); }
        if (geometryTwo !== null && !(geometryTwo instanceof adsk.core.Base)) { throw new TypeError('geometryTwo must be a adsk.core.Base'); }
        if (geometryThree === null || (geometryThree !== undefined && geometryThree !== null && !(geometryThree instanceof adsk.core.Base))) { throw new TypeError('geometryThree must be a adsk.core.Base'); }
        var args = {
            geometryOne : (geometryOne === null ? geometryOne : geometryOne.handle),
            geometryTwo : (geometryTwo === null ? geometryTwo : geometryTwo.handle)
        };
        if (geometryThree !== undefined) {
            args.geometryThree = (geometryThree === null ? geometryThree : geometryThree.handle);
        }
        var result = this._execute('measureAngle', args);
        return (result && result.value) ? adsk.createObject(result.value, adsk.core.MeasureResults) : null;
    };

    //=========== MeasureResults ============
    adsk.core.MeasureResults = function MeasureResults(handle) {
        if (!(this instanceof adsk.core.MeasureResults)) {
            return adsk.core.MeasureResults.cast(handle);
        }
        adsk.core.Base.call(this, handle);
    };
    adsk.core.MeasureResults.prototype = Object.create(adsk.core.Base.prototype);
    adsk.core.MeasureResults.prototype.constructor = adsk.core.MeasureResults;
    adsk.core.MeasureResults.classType = function classType () {
        return 'adsk::core::MeasureResults';
    };
    adsk.core.MeasureResults.interfaceId = 'adsk.core.MeasureResults';
    adsk.objectTypes['adsk.core.MeasureResults'] = adsk.core.MeasureResults;
    adsk.core.MeasureResults.cast = function (object) {
        return object instanceof adsk.core.MeasureResults ? object : null;
    };
    ...
    Object.defineProperty(adsk.core.MeasureResults.prototype, 'value', {
        get : function () {
            var result = this._execute('value');
            return result ? result.value : undefined;
        }
    ...
    Object.defineProperty(adsk.core.MeasureResults.prototype, 'positionOne', {
        get : function () {
            var result = this._execute('positionOne');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.Point3D) : null;
        }
    });
    ...
    // For an angle measurement this is one of the three points defining the angle.
    Object.defineProperty(adsk.core.MeasureResults.prototype, 'positionTwo', {
        get : function () {
            var result = this._execute('positionTwo');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.Point3D) : null;
        }
    });

    // This point is only used for angle measurements and is one of the three points defining the angle.
    Object.defineProperty(adsk.core.MeasureResults.prototype, 'positionThree', {
        get : function () {
            var result = this._execute('positionThree');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.Point3D) : null;
        }
    });
    ...
    // You can use the valueType property to determine which value type is currently used.
    Object.defineProperty(adsk.core.ValueInput.prototype, 'booleanValue', {
        get : function () {
            var result = this._execute('booleanValue');
            return result ? result.value : undefined;
        }
    });
    ...
    // Returns the newly created ValueInput object or null if the creation failed.
    adsk.core.ValueInput.createByBoolean = function (booleanValue) {
        if (typeof booleanValue !== 'boolean') { throw new TypeError('booleanValue must be a boolean'); }
        var args = {
            booleanValue : booleanValue
        };
        var result = adsk.core.Base._executeStatic('adsk.core.ValueInput', 'createByBoolean', args);
        return (result && result.value) ? adsk.createObject(result.value, adsk.core.ValueInput) : null;
    };
