...
(function (root, factory) {
    ...
    adsk.core.OrientedBoundingBox3D = function OrientedBoundingBox3D(handle) {
        if (!(this instanceof adsk.core.OrientedBoundingBox3D)) {
            return adsk.core.OrientedBoundingBox3D.cast(handle);
        }
        adsk.core.Base.call(this, handle);
    };
    adsk.core.OrientedBoundingBox3D.prototype = Object.create(adsk.core.Base.prototype);
    adsk.core.OrientedBoundingBox3D.prototype.constructor = adsk.core.OrientedBoundingBox3D;
    adsk.core.OrientedBoundingBox3D.classType = function classType () {
        return 'adsk::core::OrientedBoundingBox3D';
    };
    adsk.core.OrientedBoundingBox3D.interfaceId = 'adsk.core.OrientedBoundingBox3D';
    adsk.objectTypes['adsk.core.OrientedBoundingBox3D'] = adsk.core.OrientedBoundingBox3D;
    adsk.core.OrientedBoundingBox3D.cast = function (object) {
        return object instanceof adsk.core.OrientedBoundingBox3D ? object : null;
    };

    // Gets and sets the centerPoint point of the oriented box.
    Object.defineProperty(adsk.core.OrientedBoundingBox3D.prototype, 'centerPoint', {
        get : function () {
            var result = this._execute('centerPoint');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.Point3D) : null;
        },
        set : function (value) {
            if (value !== null && !(value instanceof adsk.core.Point3D)) { throw new TypeError('value must be a adsk.core.Point3D'); }
            ...
            var result = this._execute('centerPoint', args);
            return result ? result.value : undefined;
        }
    });
    ...
    Object.defineProperty(adsk.core.OrientedBoundingBox3D.prototype, 'lengthDirection', {
        get : function () {
            var result = this._execute('lengthDirection');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.Vector3D) : null;
        }
    });

    // Gets and sets the length of the oriented bounding box in centimeters.
    Object.defineProperty(adsk.core.OrientedBoundingBox3D.prototype, 'length', {
        get : function () {
        ...
        set : function (value) {
            ...
            var result = this._execute('length', args);
            return result ? result.value : undefined;
        }
    });
    ...
    // A unit vector is always returned.
    Object.defineProperty(adsk.core.OrientedBoundingBox3D.prototype, 'widthDirection', {
        get : function () {
            var result = this._execute('widthDirection');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.Vector3D) : null;
        }
    });

    // Gets and sets the width of the oriented bounding box in centimeters.
    Object.defineProperty(adsk.core.OrientedBoundingBox3D.prototype, 'width', {
        get : function () {
    ...
    // A unit vector is always returned.
    Object.defineProperty(adsk.core.OrientedBoundingBox3D.prototype, 'heightDirection', {
        get : function () {
            var result = this._execute('heightDirection');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.Vector3D) : null;
        }
    });

    // Gets and sets the height of the oriented bounding box in centimeters.
    Object.defineProperty(adsk.core.OrientedBoundingBox3D.prototype, 'height', {
        get : function () {
    ...
    adsk.core.OrientedBoundingBox3D.create = function (centerPoint, lengthDirection, widthDirection, length, width, height) {
        if (centerPoint !== null && !(centerPoint instanceof adsk.core.Point3D)) { throw new TypeError('centerPoint must be a adsk.core.Point3D'); }
        if (lengthDirection !== null && !(lengthDirection instanceof adsk.core.Vector3D)) { throw new TypeError('lengthDirection must be a adsk.core.Vector3D'); }
        if (widthDirection !== null && !(widthDirection instanceof adsk.core.Vector3D)) { throw new TypeError('widthDirection must be a adsk.core.Vector3D'); }
        if (!isFinite(length)) { throw new TypeError('length must be a number'); }
        ...
        var args = {
            ...
            lengthDirection : (lengthDirection === null ? lengthDirection : lengthDirection.handle),
            widthDirection : (widthDirection === null ? widthDirection : widthDirection.handle),
            length : Number(length),
            width : Number(width),
            height : Number(height)
        };
        var result = adsk.core.Base._executeStatic('adsk.core.OrientedBoundingBox3D', 'create', args);
    ...
    // the length direction.
    //
    adsk.core.OrientedBoundingBox3D.prototype.setOrientation = function (lengthDirection, widthDirection) {
        if (lengthDirection !== null && !(lengthDirection instanceof adsk.core.Vector3D)) { throw new TypeError('lengthDirection must be a adsk.core.Vector3D'); }
        if (widthDirection !== null && !(widthDirection instanceof adsk.core.Vector3D)) { throw new TypeError('widthDirection must be a adsk.core.Vector3D'); }
        var args = {
            lengthDirection : (lengthDirection === null ? lengthDirection : lengthDirection.handle),
        ...
        var result = this._execute('setOrientation', args);
        return result ? result.value : undefined;
    };
    ...
    // point : The point to test containment with.
    // Returns true if the point lies within the bounding box.
    adsk.core.OrientedBoundingBox3D.prototype.contains = function (point) {
        if (point !== null && !(point instanceof adsk.core.Point3D)) { throw new TypeError('point must be a adsk.core.Point3D'); }
        var args = {
            point : (point === null ? point : point.handle)
        };
    ...
    adsk.core.OrientedBoundingBox3D.prototype.copy = function () {
        var result = this._execute('copy');
        return (result && result.value) ? adsk.createObject(result.value, adsk.core.OrientedBoundingBox3D) : null;
    };
    ...
    // Returns true if the points are equal (have identical coordinates).
    adsk.core.Point2D.prototype.isEqualToByTolerance = function (point, tolerance) {
        if (point !== null && !(point instanceof adsk.core.Point2D)) { throw new TypeError('point must be a adsk.core.Point2D'); }
        if (!isFinite(tolerance)) { throw new TypeError('tolerance must be a number'); }
        var args = {
            point : (point === null ? point : point.handle),
        ...
        var result = this._execute('isEqualToByTolerance', args);
        return result ? result.value : undefined;
    };
    ...
    // tolerance : The tolerance, in centimeters, to use when comparing the two points.
    // Returns true if the points are equal (have identical coordinates).
    adsk.core.Point3D.prototype.isEqualToByTolerance = function (point, tolerance) {
        if (point !== null && !(point instanceof adsk.core.Point3D)) { throw new TypeError('point must be a adsk.core.Point3D'); }
        if (!isFinite(tolerance)) { throw new TypeError('tolerance must be a number'); }
        var args = {
            point : (point === null ? point : point.handle),
