...
(function (root, factory) {
    ...
    Object.defineProperty(adsk.core.Command.prototype, 'isPositionDependent', {
        get : function () {
            var result = this._execute('isPositionDependent');
            return result ? result.value : undefined;
        },
        set : function (value) {
            if (typeof value !== 'boolean') { throw new TypeError('value must be a boolean'); }
            ...
            var result = this._execute('isPositionDependent', args);
            return result ? result.value : undefined;
        }
    });
    ...
    Object.defineProperty(adsk.core.Command.prototype, 'preSelect', {
        get : function () {
            var result = this._execute('preSelect');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.SelectionEvent) : null;
        }
    });
    ...
    // The entity and mouse position on the entity can be obtained through the Selection object returned
    // through the selection property of the SelectionEventArgs object provided through the event.
    Object.defineProperty(adsk.core.Command.prototype, 'preSelectMouseMove', {
        get : function () {
            var result = this._execute('preSelectMouseMove');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.SelectionEvent) : null;
        }
    });
    ...
    // The entity and mouse position on the entity can be obtained through the Selection object returned
    // through the selection property of the SelectionEventArgs object provided through the event.
    Object.defineProperty(adsk.core.Command.prototype, 'preSelectEnd', {
        get : function () {
            var result = this._execute('preSelectEnd');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.SelectionEvent) : null;
        }
    });
    ...
    // The entity and mouse position on the entity can be obtained through the Selection object returned
    // through the selection property of the SelectionEventArgs object provided through the event.
    Object.defineProperty(adsk.core.Command.prototype, 'select', {
        get : function () {
            var result = this._execute('select');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.SelectionEvent) : null;
        }
    });
    ...
    // The entity and mouse position on the entity can be obtained through the Selection object returned
    // through the selection property of the SelectionEventArgs object provided through the event.
    Object.defineProperty(adsk.core.Command.prototype, 'unselect', {
        get : function () {
            var result = this._execute('unselect');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.SelectionEvent) : null;
        }
    });
    ...
    adsk.core.Command.prototype.setCursor = function (cursorImage, xHotSpot, yHotSpot) {
        if (cursorImage === undefined || cursorImage === null || cursorImage.constructor !== String) { throw new TypeError('cursorImage must be a string'); }
        if (!isFinite(xHotSpot)) { throw new TypeError('xHotSpot must be a number'); }
        if (!isFinite(yHotSpot)) { throw new TypeError('yHotSpot must be a number'); }
        var args = {
            cursorImage : cursorImage,
            xHotSpot : Number(xHotSpot),
            yHotSpot : Number(yHotSpot)
        };
        var result = this._execute('setCursor', args);
        return result ? result.value : undefined;
    };
    ...
    adsk.core.Command.prototype.getCursor = function (cursorImage, xHotSpot, yHotSpot) {
        if (typeof cursorImage !== 'object') { throw new TypeError('cursorImage must be an object'); }
        if (typeof xHotSpot !== 'object') { throw new TypeError('xHotSpot must be an object'); }
        if (typeof yHotSpot !== 'object') { throw new TypeError('yHotSpot must be an object'); }
        var args = {
            cursorImage : null,
            xHotSpot : null,
            yHotSpot : null
        };
        var result = this._execute('getCursor', args);
        if (result && result.outargs) {
            cursorImage.value = (result.outargs.cursorImage !== undefined) ? result.outargs.cursorImage : undefined;
            xHotSpot.value = (result.outargs.xHotSpot !== undefined) ? result.outargs.xHotSpot : undefined;
            yHotSpot.value = (result.outargs.yHotSpot !== undefined) ? result.outargs.yHotSpot : undefined;
        }
        return result ? result.value : undefined;
    };
    ...
    adsk.core.FolderDialog = function FolderDialog(handle) {
        if (!(this instanceof adsk.core.FolderDialog)) {
            return adsk.core.FolderDialog.cast(handle);
        }
        adsk.core.Base.call(this, handle);
    };
    adsk.core.FolderDialog.prototype = Object.create(adsk.core.Base.prototype);
    adsk.core.FolderDialog.prototype.constructor = adsk.core.FolderDialog;
    adsk.core.FolderDialog.classType = function classType () {
        return 'adsk::core::FolderDialog';
    };
    adsk.core.FolderDialog.interfaceId = 'adsk.core.FolderDialog';
    adsk.objectTypes['adsk.core.FolderDialog'] = adsk.core.FolderDialog;
    adsk.core.FolderDialog.cast = function (object) {
        return object instanceof adsk.core.FolderDialog ? object : null;
    };

    // Gets or sets the title displayed on the dialog.
    Object.defineProperty(adsk.core.FolderDialog.prototype, 'title', {
        get : function () {
            var result = this._execute('title');
            return result ? result.value : undefined;
        },
    ...
    Object.defineProperty(adsk.core.FolderDialog.prototype, 'folder', {
        get : function () {
            var result = this._execute('folder');
            return result ? result.value : undefined;
        }
    });

    // Gets or sets the initial directory displayed by the file dialog box.
    Object.defineProperty(adsk.core.FolderDialog.prototype, 'initialDirectory', {
        get : function () {
            var result = this._execute('initialDirectory');
            return result ? result.value : undefined;
        },
    ...
    // Returns an enum value indicating which button was clicked on the dialog.
    adsk.core.FolderDialog.prototype.showDialog = function () {
        var result = this._execute('showDialog');
        return result ? result.value : undefined;
    };
    ...
    adsk.core.ListItems.prototype.clear = function () {
        var result = this._execute('clear');
        return result ? result.value : undefined;
    };
    ...
    adsk.core.Palettes.prototype.add = function (id, name, htmlFileURL, isVisible, showCloseButton, isResizable, width, height, useNewWebBrowser) {
        if (id === undefined || id === null || id.constructor !== String) { throw new TypeError('id must be a string'); }
        if (name === undefined || name === null || name.constructor !== String) { throw new TypeError('name must be a string'); }
        ...
        if (useNewWebBrowser === null || (useNewWebBrowser !== undefined && typeof useNewWebBrowser !== 'boolean')) { throw new TypeError('useNewWebBrowser must be a boolean'); }
        var args = {
            id : id,
            name : name,
        ...
        if (useNewWebBrowser !== undefined) {
            args.useNewWebBrowser = useNewWebBrowser;
        }
        var result = this._execute('add', args);
    ...
    adsk.core.Selections.prototype.asArray = function () {
        ...
        var resultValue = [];
        for (resultIter = 0; resultIter < result.value.length; ++resultIter) {
            resultValue[resultIter] = (result.value[resultIter] !== undefined) ? adsk.createObject(result.value[resultIter], adsk.core.Selection) : null;
        }
        return resultValue
    };
    ...
    adsk.core.ToolbarPanel.prototype.indexWithinTab = function (tabId) {
        if (tabId === undefined || tabId === null || tabId.constructor !== String) { throw new TypeError('tabId must be a string'); }
        var args = {
            tabId : tabId
        };
        var result = this._execute('indexWithinTab', args);
        return result ? result.value : undefined;
    };
    ...
    adsk.core.ToolbarTab = function ToolbarTab(handle) {
        if (!(this instanceof adsk.core.ToolbarTab)) {
            return adsk.core.ToolbarTab.cast(handle);
        }
        adsk.core.Base.call(this, handle);
    };
    adsk.core.ToolbarTab.prototype = Object.create(adsk.core.Base.prototype);
    adsk.core.ToolbarTab.prototype.constructor = adsk.core.ToolbarTab;
    adsk.core.ToolbarTab.classType = function classType () {
        return 'adsk::core::ToolbarTab';
    };
    adsk.core.ToolbarTab.interfaceId = 'adsk.core.ToolbarTab';
    adsk.objectTypes['adsk.core.ToolbarTab'] = adsk.core.ToolbarTab;
    adsk.core.ToolbarTab.cast = function (object) {
        return object instanceof adsk.core.ToolbarTab ? object : null;
    };

    // Gets The unique, language independent, ID of this tab.
    Object.defineProperty(adsk.core.ToolbarTab.prototype, 'id', {
        get : function () {
            var result = this._execute('id');
            return result ? result.value : undefined;
        }
    ...
    // associated with a workspace, which is a subset of the entire
    // list of tabs.
    Object.defineProperty(adsk.core.ToolbarTab.prototype, 'index', {
        get : function () {
            var result = this._execute('index');
            return result ? result.value : undefined;
        }
    ...
    Object.defineProperty(adsk.core.ToolbarTab.prototype, 'isVisible', {
        get : function () {
            var result = this._execute('isVisible');
            return result ? result.value : undefined;
        }
    ...
    Object.defineProperty(adsk.core.ToolbarTab.prototype, 'name', {
        get : function () {
            var result = this._execute('name');
            return result ? result.value : undefined;
        }
    ...
    Object.defineProperty(adsk.core.ToolbarTab.prototype, 'toolbarPanels', {
        get : function () {
    ...
    // Gets the parent UserInterface object.
    Object.defineProperty(adsk.core.ToolbarTab.prototype, 'parentUserInterface', {
        get : function () {
            var result = this._execute('parentUserInterface');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.UserInterface) : null;
        }
    ...
    Object.defineProperty(adsk.core.ToolbarTab.prototype, 'productType', {
        get : function () {
            var result = this._execute('productType');
            return result ? result.value : undefined;
        }
    ...
    Object.defineProperty(adsk.core.ToolbarTab.prototype, 'isActive', {
        get : function () {
    ...
    Object.defineProperty(adsk.core.ToolbarTab.prototype, 'isNative', {
        get : function () {
            var result = this._execute('isNative');
            return result ? result.value : undefined;
        }
    ...
    adsk.core.ToolbarTab.prototype.activate = function () {
        var result = this._execute('activate');
        return result ? result.value : undefined;
    };
    ...
    // Returns true if the delete was successful.
    adsk.core.ToolbarTab.prototype.deleteMe = function () {
        var result = this._execute('deleteMe');
        return result ? result.value : undefined;
    };
    ...
    adsk.core.ToolbarTabList = function ToolbarTabList(handle) {
        if (!(this instanceof adsk.core.ToolbarTabList)) {
            return adsk.core.ToolbarTabList.cast(handle);
        }
        adsk.core.Base.call(this, handle);
    };
    adsk.core.ToolbarTabList.prototype = Object.create(adsk.core.Base.prototype);
    adsk.core.ToolbarTabList.prototype.constructor = adsk.core.ToolbarTabList;
    adsk.core.ToolbarTabList.classType = function classType () {
        return 'adsk::core::ToolbarTabList';
    };
    adsk.core.ToolbarTabList.interfaceId = 'adsk.core.ToolbarTabList';
    adsk.objectTypes['adsk.core.ToolbarTabList'] = adsk.core.ToolbarTabList;
    adsk.core.ToolbarTabList.cast = function (object) {
        return object instanceof adsk.core.ToolbarTabList ? object : null;
    };

    // Gets the number of toolbar tabs in the collection.
    Object.defineProperty(adsk.core.ToolbarTabList.prototype, 'count', {
        get : function () {
            var result = this._execute('count');
            return result ? result.value : undefined;
        }
    ...
    // index : The index of the item within the collection to return. The first item in the collection has an index of 0.
    // Returns the specified item or null if an invalid index was specified.
    adsk.core.ToolbarTabList.prototype.item = function (index) {
        if (!isFinite(index)) { throw new TypeError('index must be a number'); }
        var args = {
            index : Number(index)
        };
        var result = this._execute('item', args);
        return (result && result.value) ? adsk.createObject(result.value, adsk.core.ToolbarTab) : null;
    };
    ...
    adsk.core.ToolbarTabList.prototype.itemById = function (id) {
        if (id === undefined || id === null || id.constructor !== String) { throw new TypeError('id must be a string'); }
        var args = {
            id : id
        };
    ...
    adsk.core.ToolbarTabs = function ToolbarTabs(handle) {
        if (!(this instanceof adsk.core.ToolbarTabs)) {
            return adsk.core.ToolbarTabs.cast(handle);
        }
        adsk.core.Base.call(this, handle);
    };
    adsk.core.ToolbarTabs.prototype = Object.create(adsk.core.Base.prototype);
    adsk.core.ToolbarTabs.prototype.constructor = adsk.core.ToolbarTabs;
    adsk.core.ToolbarTabs.classType = function classType () {
        return 'adsk::core::ToolbarTabs';
    };
    adsk.core.ToolbarTabs.interfaceId = 'adsk.core.ToolbarTabs';
    adsk.objectTypes['adsk.core.ToolbarTabs'] = adsk.core.ToolbarTabs;
    adsk.core.ToolbarTabs.cast = function (object) {
        return object instanceof adsk.core.ToolbarTabs ? object : null;
    };

    // Gets the number of ToolbarTabs.
    Object.defineProperty(adsk.core.ToolbarTabs.prototype, 'count', {
        get : function () {
            var result = this._execute('count');
            return result ? result.value : undefined;
        }
    ...
    // index : The index of the item within the collection to return. The first item in the collection has an index of 0.
    // Returns the specified item or null if an invalid index was specified.
    adsk.core.ToolbarTabs.prototype.item = function (index) {
        if (!isFinite(index)) { throw new TypeError('index must be a number'); }
        var args = {
            index : Number(index)
        };
    ...
    adsk.core.ToolbarTabs.prototype.itemById = function (id) {
        if (id === undefined || id === null || id.constructor !== String) { throw new TypeError('id must be a string'); }
        var args = {
            id : id
        };
    ...
    adsk.core.ToolbarTabs.prototype.add = function (id, name) {
        if (id === undefined || id === null || id.constructor !== String) { throw new TypeError('id must be a string'); }
        if (name === undefined || name === null || name.constructor !== String) { throw new TypeError('name must be a string'); }
        var args = {
            id : id,
    ...
    // available, regardless of which workspace or product they're associated with.
    Object.defineProperty(adsk.core.UserInterface.prototype, 'allToolbarTabs', {
        get : function () {
            var result = this._execute('allToolbarTabs');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.ToolbarTabList) : null;
        }
    });

    // Returns true if Tabbed Toolbars are being used.
    // Returns true if using Tabbed Toolbars.
    Object.defineProperty(adsk.core.UserInterface.prototype, 'isTabbedToolbarUI', {
        get : function () {
            var result = this._execute('isTabbedToolbarUI');
            return result ? result.value : undefined;
        }
    });
    ...
    adsk.core.UserInterface.prototype.createFolderDialog = function () {
        var result = this._execute('createFolderDialog');
        return (result && result.value) ? adsk.createObject(result.value, adsk.core.FolderDialog) : null;
    };
    ...
    adsk.core.UserInterface.prototype.toolbarTabsByProductType = function (productType) {
        if (productType === undefined || productType === null || productType.constructor !== String) { throw new TypeError('productType must be a string'); }
        var args = {
            productType : productType
        };
        var result = this._execute('toolbarTabsByProductType', args);
        return (result && result.value) ? adsk.createObject(result.value, adsk.core.ToolbarTabList) : null;
    };
    ...
    Object.defineProperty(adsk.core.Workspace.prototype, 'toolClipFilename', {
        get : function () {
            var result = this._execute('toolClipFilename');
            return result ? result.value : undefined;
        },
    ...
    Object.defineProperty(adsk.core.Workspace.prototype, 'tooltip', {
        get : function () {
            var result = this._execute('tooltip');
            return result ? result.value : undefined;
        },
    ...
    Object.defineProperty(adsk.core.Workspace.prototype, 'tooltipDescription', {
        get : function () {
            var result = this._execute('tooltipDescription');
            return result ? result.value : undefined;
        },
    ...
    Object.defineProperty(adsk.core.Workspace.prototype, 'toolbarTabs', {
        get : function () {
            var result = this._execute('toolbarTabs');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.ToolbarTabs) : null;
        }
    });
    ...
    adsk.core.SelectionCommandInput.CustomGraphics = 'CustomGraphics';
    ...
    adsk.core.TextCommandPalette = function TextCommandPalette(handle) {
        if (!(this instanceof adsk.core.TextCommandPalette)) {
            return adsk.core.TextCommandPalette.cast(handle);
        }
        adsk.core.Palette.call(this, handle);
    };
    adsk.core.TextCommandPalette.prototype = Object.create(adsk.core.Palette.prototype);
    adsk.core.TextCommandPalette.prototype.constructor = adsk.core.TextCommandPalette;
    adsk.core.TextCommandPalette.classType = function classType () {
        return 'adsk::core::TextCommandPalette';
    };
    adsk.core.TextCommandPalette.interfaceId = 'adsk.core.TextCommandPalette';
    adsk.objectTypes['adsk.core.TextCommandPalette'] = adsk.core.TextCommandPalette;
    adsk.core.TextCommandPalette.cast = function (object) {
        return object instanceof adsk.core.TextCommandPalette ? object : null;
    };
    ...
    // Returns true if successful.
    adsk.core.TextCommandPalette.prototype.writeText = function (text) {
        if (text === undefined || text === null || text.constructor !== String) { throw new TypeError('text must be a string'); }
        var args = {
            text : text
        };
        var result = this._execute('writeText', args);
        return result ? result.value : undefined;
    };
