...
longDescription = "Generic post for TinyG.";
...
properties = {
  ...
  useG28: false // specifies to use G28 for retracts
};
...
propertyDefinitions = {
  ...
  useG28: {title:"Use G28", description:"Disable to avoid G28 output for safe machine retracts - when disabled the maximum clearance height is used instead.", type:"boolean"}
};
