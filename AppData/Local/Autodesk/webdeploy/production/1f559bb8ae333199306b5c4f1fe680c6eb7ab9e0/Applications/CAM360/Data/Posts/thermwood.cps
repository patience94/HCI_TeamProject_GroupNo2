...
propertyDefinitions = {
  ...
  allow3DArcs: {title:"Allow 3D arcs", description:"Specifies that circular moves in the non-primary planes should be output using G72/G73. When disabled, these moves will be linearized.", type:"boolean"},
  useCannedCycles: {title:"Use canned cycles", description:"Specifies that canned cycles should be output instead of being expanded.", type:"boolean"},
  writeVersion: {title:"Write version", description:"Write the version number in the header of the code.", group:0, type:"boolean"},
  acceleration: {title:"Acceleration", description:"Specifies the G8xx acceleration macro.", type:"integer", range:[0, 10]},
  tangency: {title:"Tangency", description:"Specifies the G9 tangency factory.", type:"integer", range:[0, 40]}
};
...
function onOpen() {
  ...
  if ((properties.tangency <= 0) || (properties.tangency > 40)) {
