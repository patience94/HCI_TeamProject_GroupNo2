...
properties = {
  ...
  gotCAxis: false, // got C axis
  fourthAxisAround: "None", // fourth axis mounted along
...
propertyDefinitions = {
  ...
  laserToolNumber: {title:"Laser tool number", description:"Sets the tool number used for laser cutting.", type:"boolean"},
  laserEtchPower: {title:"Laser etch power", description:"Sets the laser etch power.", type:"number"},
  laserPower: {title:"Laser power", description:"Sets the laser power.", type:"number"},
  useLaserM3M5: {title:"Use Laser M3/M5", description:"Enable to activate the laser using M3/M5.", type:"boolean"},
  gotCAxis: {title:"Got C axis", description:"Defines whether the machine has a C axis.", type:"boolean"},
