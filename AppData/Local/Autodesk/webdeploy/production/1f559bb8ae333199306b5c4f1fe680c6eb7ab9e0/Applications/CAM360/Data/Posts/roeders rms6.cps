...
propertyDefinitions = {
  graphite: {title:"Graphite", description:"Graphite if enabled, steel otherwise.", type:"boolean"},
  RMAX: {title:"RMAX", description:"RMAX value in MM, only used for finishing strategies.", type:"number"},
  cleanAir: {title:"Clean tool with air", description:"If enabled, the tool will be cleaned with air on a toolchange.", type:"boolean"},
  diameterDiff: {title:"Diameter tolerance", description:"Diameter tolerance used for measurement.", type:"number"},
  // tipDiff: {title:"Corner radius tolerance", description:"Corner radius tolerance for measurement.", type:"number"},
  toolMeasurementOffset: {title:"Tool measurement offset", description:"The height above the tool corner for measuring the tool diameter.", type:"number"},
  ...
  allowArcs: {title:"Allow arcs", description:"If disabled, all arcs will be linearized.", type:"boolean"},
