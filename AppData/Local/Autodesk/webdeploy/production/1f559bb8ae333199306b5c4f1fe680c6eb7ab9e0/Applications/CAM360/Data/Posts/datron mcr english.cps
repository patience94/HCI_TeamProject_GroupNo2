/**
  DEPRECATED POST USE DATRON MCR INSTEAD
...
description = "Datron MCR (English)";
deprecatedDescription = "This post has been deprecated. Use the Datron MCR post instead.";
