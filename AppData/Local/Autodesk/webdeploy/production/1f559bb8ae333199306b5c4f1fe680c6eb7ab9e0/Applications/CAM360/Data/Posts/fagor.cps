...
properties = {
  ...
  contouringAcceleration: 60, // acceleration percentage used for G51 look-ahead smoothing
  contouringError: 0.001, // error allowed during G51 look-ahead smoothing
...
propertyDefinitions = {
  ...
  useSmoothing: {title:"Use smoothing", description:"Specifies if smoothing (G51) should be used or not.", type:"boolean"},
  contouringAcceleration: {title:"Smoothing contouring acceleration", description:"Acceleration percentage used for G51 look-ahead smoothing.", type:"number"},
  contouringError: {title:"Smoothing contouring error", description:"Error allowed during G51 look-ahead smoothing.", type:"number"},
  rotaryTableAxis: {
...
function setSmoothing(mode) {
  ...
  if (mode) {
    writeBlock(
      gFormat.format(51),
      "A" + accelFormat.format(properties.contouringAcceleration),
      "E" + eFormat.format(properties.contouringError)
    ); // enable look ahead
  } else {
...
function onCircular(clockwise, cx, cy, cz, x, y, z, feed) {
  ...
  if (isFullCircle()) {
    ...
    case PLANE_XY:
      ...
      writeBlock(gAbsIncModal.format(90), conditional(!properties.useG16, gPlaneModal.format(17)), gFeedModeModal.format(94), gMotionModal.format(clockwise ? 2 : 3), iOutput.format(cx - start.x, 0), jOutput.format(cy - start.y, 0), feedOutput.format(feed));
      break;
    case PLANE_ZX:
      if (properties.useG16) {
        writeBlock(getG16("ZX"));
      }
      writeBlock(gAbsIncModal.format(90), conditional(!properties.useG16, gPlaneModal.format(18)), gFeedModeModal.format(94), gMotionModal.format(clockwise ? 2 : 3), iOutput.format(cx - start.x, 0), kOutput.format(cz - start.z, 0), feedOutput.format(feed));
      break;
    case PLANE_YZ:
      if (properties.useG16) {
        writeBlock(getG16("YZ"));
      }
      writeBlock(gAbsIncModal.format(90), conditional(!properties.useG16, gPlaneModal.format(19)), gFeedModeModal.format(94), gMotionModal.format(clockwise ? 2 : 3), jOutput.format(cy - start.y, 0), kOutput.format(cz - start.z, 0), feedOutput.format(feed));
      break;
    default:
      linearize(tolerance);
    }
    ...
    case PLANE_XY:
      ...
      writeBlock(gAbsIncModal.format(90), conditional(!properties.useG16, gPlaneModal.format(17)), gFeedModeModal.format(94), gMotionModal.format(clockwise ? 2 : 3), xOutput.format(x), yOutput.format(y), iOutput.format(cx - start.x, 0), jOutput.format(cy - start.y, 0), zOutput.format(z), feedOutput.format(feed));
      break;
    case PLANE_ZX:
      if (isHelical()) {
        linearize(tolerance);
      ...
      writeBlock(gAbsIncModal.format(90), conditional(!properties.useG16, gPlaneModal.format(18)), gFeedModeModal.format(94), gMotionModal.format(clockwise ? 2 : 3), xOutput.format(x), yOutput.format(y), zOutput.format(z), iOutput.format(cx - start.x, 0), kOutput.format(cz - start.z, 0), feedOutput.format(feed));
      break;
    case PLANE_YZ:
      if (isHelical()) {
        linearize(tolerance);
      ...
      writeBlock(gAbsIncModal.format(90), conditional(!properties.useG16, gPlaneModal.format(19)), gFeedModeModal.format(94), gMotionModal.format(clockwise ? 2 : 3), xOutput.format(x), yOutput.format(y), zOutput.format(z), jOutput.format(cy - start.y, 0), kOutput.format(cz - start.z, 0), feedOutput.format(feed));
      break;
    default:
      linearize(tolerance);
    }
