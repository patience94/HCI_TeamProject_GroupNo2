/**
  ...
  $Revision: 42645 dab327b1b16b423b75c69877cc91aea7ea31c0ac $
  $Date: 2020-02-06 06:32:21 $
...
function onSection() {
  ...
  if (properties.useIncremental && !isProbeOperation()) {
  ...
  if (isFirstCyclePoint() || isProbeOperation()) {
    ...
    case "probing-x":
      ...
      writeBlock(
        ...
        xOutput.format(x + approach(cycle.approach1) * (cycle.probeClearance + tool.diameter / 2)),
    ...
    case "probing-y":
      ...
      writeBlock(
        gFormat.format(65), "P" + 9811,
        yOutput.format(y + approach(cycle.approach1) * (cycle.probeClearance + tool.diameter / 2)),
        "Q" + xyzFormat.format(cycle.probeOvertravel),
        getProbingArguments(cycle, probeWorkOffsetCode)
      );
      break;
