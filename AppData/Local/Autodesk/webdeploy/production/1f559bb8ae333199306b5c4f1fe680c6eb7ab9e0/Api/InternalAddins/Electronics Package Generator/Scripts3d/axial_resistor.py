...
def axial_resistor(params, design = None, target_comp = None):
    ...
    if is_parametric:
        ...
        if is_update: 
            ...
            body_appearance = model_3d_utility.get_appearance(app, design,model_3d_utility.COLOR_NAME_AXIAL_RESISTOR_BODY)
            # get the color property and update the RGB value
            color_prop = adsk.core.ColorProperty.cast(body_appearance.appearanceProperties.itemById(model_3d_utility.COLOR_PROP_ID_DEFAULT))
    ...
    model_3d_utility.apply_rgb_appearance(app, design, rev_body.bodies.item(0),color_r, color_g, color_b, 'axial_res_ind_color')
